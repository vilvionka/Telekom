...
(() => {
    ...
    function activePopUp() {
        var totalNum = document.querySelector('.total_price_calc_inet_num').innerHTML; // итоговая цена value
        var rightSpeedTariff = document.querySelector('.speed_tariff_top_right_box span b').innerHTML; // скорость интернета число
        var rightTV = document.querySelector('.tv_text_top_right_box span'); // телевидение твин плэй
        var calcKinoStart = document.querySelector('#squaredTwo_inet3');
        var calcKinoAmediateca = document.querySelector('#squaredTwo_inet4');
        var rightAntivirus = document.querySelector('.antivirus_text_top_right_box');
        ...
        // скорость интернета
        inputinSpeed.value = 'Скорость интернета:' + ' ' + rightSpeedTariff + ' '  + 'Мб/с';
        ...
        if(calcKinoStart.checked == true){
            ...
            inputStart.value = 'Онлайн кинотеатр Start';
        }
        else{
        ...
        if(calcKinoAmediateca.checked == true){
            ...
            inputAmedia.value = 'Онлайн кинотеатр Amediateca';
        }
        else{
        ...
        if(rightAntivirus.style.display == 'block'){
           inputVirus.style.display = 'block';
            inputVirus.value = "Антивирус «Касперский»";
        }else{
